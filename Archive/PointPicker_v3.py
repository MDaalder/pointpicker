...
picked points .txt file.

Example command line/terminal input:
    >>>python PointPicker.py \input\path\image.nii \output\directory\path\

Press 'p' to place a point at the location of your cursor.
Press 'z' to remove a point at the location of your cursor.
Press 't' to print out a file containing thecoordintaes of the points picked.
...
# python PointPicker_v3.py C:/Users/mattd/Documents/GitHub/pointpicker/head.nii C:/Users/mattd/Documents/GitHub/pointpicker/
...
def PointPicker(input_filename, output_dir, overwrite=False):
    ...
    def printPoints(interactor, event):
        ...
        if keyPress == 't':
            ...
            result = input('Please name the points file to be stored in \"{}" in .txt format. \n'.format(output_dir))
...
def main():
    ...
    parser.add_argument('output_dir', help='Output directory to print file listing picked points')
