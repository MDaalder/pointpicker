...
This code takes the medical image, applies a gaussin filter, segments the filtered 
...
# python PointPicker_v2.py C:/Users/mattd/Documents/GitHub/pointpicker/head.nii C:/Users/mattd/Documents/GitHub/pointpicker/head_points.txt 

import sys
sys.path.insert(0, "C:/Users/mattd/Documents/GitHub/pointpicker")

from echo_arguments import echo_arguments
from points import write_points
from vtk_helpers import get_vtk_reader
...
def PointPicker(input_filename, output_dir, overwrite=False):
    ...
    # =============================================================================
    # Press 'p' to add a point to the display and to the existing point dicts
    ...
    # =============================================================================
    # Press 'z' to delete a point from the display and the existing point dicts
    # Initialised on key press event in the interactor
    # =============================================================================
    ...
    # =============================================================================
    # Prints out a .txt file the points picked and displayed in the image window 
    ...
    def printPoints(interactor, event):
        ...
        precision = 4
        keyPress = interactor.GetKeySym()
        # output_dir = os.path(output_filename)
        
        if keyPress == 't':
            
            # check if output directory exists
            if os.path.isdir(output_dir):
                result = input('Please name your new points .txt file to be stored in \"{}"\.' .format(output_dir))
                output_file = str(output_dir) + str(result)
